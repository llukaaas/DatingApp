...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            await Groups.AddToGroupAsync(Context.ConnectionId, groupName);//dodavanje u signalR grupu
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if(group.Connections.Any(x => x.Username == recipient.UserName)) //da li ce doiti poruku
            {
        ...
        {
            var group = await _uow.MessageRepository.GetGroupForConnectin(Context.ConnectionId);
